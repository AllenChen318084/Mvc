...
namespace Microsoft.AspNetCore.Mvc.ViewFeatures
{
    ...
    public class CookieTempDataProvider : ITempDataProvider
    {
        ...
        public IDictionary<string, object> LoadTempData(HttpContext context)
        {
            ...
            {
                var base64AndUrlEncodedValue = _chunkingCookieManager.GetRequestCookie(context, CookieName);
                if (!string.IsNullOrEmpty(base64AndUrlEncodedValue))
                {
                    var protectedData = Base64UrlTextEncoder.Decode(base64AndUrlEncodedValue);
        ...
        public void SaveTempData(HttpContext context, IDictionary<string, object> values)
        {
            ...
            if (hasValues)
            {
                ...
                var base64AndUrlEncodedValue = Base64UrlTextEncoder.Encode(bytes);
                _chunkingCookieManager.AppendResponseCookie(context, CookieName, base64AndUrlEncodedValue, cookieOptions);
            }
            else
            {
